...
const DEFAULT_CODE = `import { motion } from "framer-motion";
...
export const GlassCodeWalk = ({
  ...
  return (
    ...
    >
      <>
        <style>{`
          @keyframes framecn-gcw-line {
            from { opacity: 0; transform: translateY(4px); }
            to { opacity: 1; transform: translateY(0); }
          }
          @keyframes framecn-gcw-aura {
        ...
        <div
          style={{
            animation: "framecn-gcw-aura 10s ease-in-out infinite",
            background:
            ...
            >
              {lines.map((line, i) => (
                <div
                  key={i}
                  style={{
                    animation: `framecn-gcw-line ${staggerMs}ms cubic-bezier(0.16, 1, 0.3, 1) ${i * staggerMs}ms backwards`,
                  }}
                >
                  <CodeLine
                    line={line}
