...
<ComponentPreview name="highlight" hideCode />
...
```bash
npx shadcn@latest add @framecn/highlight
```
...
```tsx
import { CaptionHighlight } from "@/components/framecn/highlight";
import type { CaptionWord } from "@/components/framecn/highlight";
```
